...
#ifndef ROS_GZ_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
#define ROS_GZ_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros_gz_interfaces__msg__Light __attribute__((deprecated))
#else
# define DEPRECATED__ros_gz_interfaces__msg__Light __declspec(deprecated)
#endif
...
struct Light_
{
  ...
  // pointer types
  using RawPtr =
    ros_gz_interfaces::msg::Light_<ContainerAllocator> *;
  using ConstRawPtr =
    const ros_gz_interfaces::msg::Light_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ros_gz_interfaces::msg::Light_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ros_gz_interfaces__msg__Light
    std::shared_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_gz_interfaces__msg__Light
    std::shared_ptr<ros_gz_interfaces::msg::Light_<ContainerAllocator> const>
...
using Light =
  ros_gz_interfaces::msg::Light_<std::allocator<void>>;
...
#endif  // ROS_GZ_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
