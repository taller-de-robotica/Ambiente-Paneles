...
#ifndef ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
#define ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ros_ign_interfaces__msg__Light __attribute__((deprecated))
#else
# define DEPRECATED__ros_ign_interfaces__msg__Light __declspec(deprecated)
#endif
...
struct Light_
{
  ...
  typedef DEPRECATED__ros_ign_interfaces__msg__Light
    std::shared_ptr<ros_ign_interfaces::msg::Light_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ros_ign_interfaces__msg__Light
    std::shared_ptr<ros_ign_interfaces::msg::Light_<ContainerAllocator> const>
...
#endif  // ROS_IGN_INTERFACES__MSG__DETAIL__LIGHT__STRUCT_HPP_
